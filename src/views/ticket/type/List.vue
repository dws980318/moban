      ...
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <el-form :inline="true">
            ...
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择权限">
                <el-option
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="menuName" label="设置权限" width="auto" header-align="center"></el-table-column>
