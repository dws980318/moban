      ...
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <el-form :inline="true">
            ...
            <el-form-item label>
              <el-input size="small" v-model="searchData.name" placeholder="角色名称"></el-input>
            </el-form-item>
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择角色">
                <el-option
            ...
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择学院">
                <el-option
                  v-for="(item, key, index) in options"
                  :key="index"
                  :label="item.name"
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="name" label="角色" width="200" align="center"></el-table-column>
            <el-table-column prop="name" label="姓名" width="200" align="center"></el-table-column>
            <el-table-column prop="name" label="学院" width="200" align="center"></el-table-column>
            <el-table-column prop="menuName" label="联系方式" width="auto" header-align="center"></el-table-column>
            <el-table-column label="编辑权限" width="150" align="center">
              <template slot-scope="scope">
                <el-button
                  size="mini"
                  type="success"
                  @click="handleEdits(scope.$index, scope.row.id)"
                >编辑</el-button>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleEdits(index, id) {
      this.$router.push("/ticket/code/Detail/" + id);
    },
    handleDelete(index) {
