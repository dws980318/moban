      ...
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <el-form :inline="true">
            ...
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择考生类型">
                <el-option
            ...
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择生源地">
                <el-option
                  v-for="(item, key, index) in options"
                  :key="index"
                  :label="item.name"
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="name" label="生源地" width="200" align="center"></el-table-column>
            <el-table-column prop="menuName" label="考生类型" width="auto" header-align="center"></el-table-column>
            <el-table-column prop="menuName" label="身份证号码" width="auto" header-align="center"></el-table-column>
            <el-table-column prop="menuName" label="联系方式" width="auto" header-align="center"></el-table-column>
            <el-table-column prop="menuName" label="注册时间" width="auto" header-align="center"></el-table-column>
            <el-table-column prop="menuName" label="注册信息" width="auto" align="center">
...
export default {
  ...
  methods: {
    ...
    hanldeAdd() {
      // 添加
      this.$router.push("/ticket/examinee/add");
    },
    handleSee(index, id) {
      this.$router.push("/ticket/examinee/Detail/" + id);
    },
    showModal(index) {
    ...
    handleEdit(index, id) {
      this.$router.push("/ticket/examinee/" + id);
    },
    handleDelete(index) {
