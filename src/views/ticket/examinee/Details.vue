  ...
  <div class="details">
    ...
    <div class="form">
      <el-form :model="form" ref="checkForm" label-width="150px" :rules="formrules">
        ...
        <el-form-item label="证件类型：" prop="typeid">
          <el-select style="width: 350px;" size="small" v-model="form.typeid" placeholder="请选择证件类型">
            <el-option v-for="item in options" :key="item.id" :label="item.name" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="考生类型：" prop="typeid">
          <el-select style="width: 350px;" size="small" v-model="form.typeid" placeholder="请选择考生类型">
            <el-option v-for="item in options" :key="item.id" :label="item.name" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="生源地：" prop="typeid">
          <el-select style="width: 350px;" size="small" v-model="form.typeid" placeholder="请选择生源地">
            <el-option v-for="item in options" :key="item.id" :label="item.name" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="证件号码：" prop="orderid">
          <el-input type="text" size="small" v-model="form.orderid" placeholder="请输入证件号码"></el-input>
        </el-form-item>
        <el-form-item label="本人手机：" prop="orderid">
          <el-input type="text" size="small" v-model="form.orderid" placeholder="请输入本人手机"></el-input>
        </el-form-item>
        <el-form-item label="邮箱地址：" prop="orderid">
          <el-input type="text" size="small" v-model="form.orderid" placeholder="请输入邮箱地址"></el-input>
        </el-form-item>
