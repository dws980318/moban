  ...
  <div class="details">
    ...
    <div class="form">
      <el-form :model="form" ref="checkForm" label-width="150px" :rules="formrules">
        ...
        <el-form-item label="门票名称：" prop="distributor">
          <el-input size="small" v-model="form.distributor" placeholder="请输入门票名称"></el-input>
        </el-form-item>
        <el-form-item label="门票库存：" prop="total">
          <el-input type="number" size="small" v-model="form.total" placeholder="请输入门票库存"></el-input>
        </el-form-item>
...
<!--        </el-form-item>-->
        <el-form-item label="门票说明：" prop="place">
          <el-input style="width: 90%" type="textarea" :autosize="{ minRows: 6, maxRows: 10}" resize="none" show-word-limit v-model="form.place" placeholder="请输入门票说明"></el-input>
        </el-form-item>
