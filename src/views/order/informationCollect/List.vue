      ...
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <el-form :inline="true">
            ...
            <el-form-item label>
              <el-input size="small" v-model="searchData.name" placeholder="模板名称"></el-input>
            </el-form-item>
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择管理员">
                <el-option
            ...
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择已配置考试">
                <el-option
                  v-for="(item, key, index) in options"
                  :key="index"
                  :label="item.name"
            ...
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择状态">
                <el-option
                  v-for="(item, key, index) in options"
                  :key="index"
                  :label="item.name"
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="name" label="模板名称" width="200" align="center"></el-table-column>
            <el-table-column prop="name" label="状态" width="200" align="center"></el-table-column>
            <el-table-column prop="name" label="状态操作" width="auto" align="center"></el-table-column>
            <el-table-column prop="name" label="管理员" width="auto" align="center"></el-table-column>
            <el-table-column prop="name" label="创建时间" width="160" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    hanldeAdd() {
      // 添加
      this.$router.push("/order/informationCollect/add");
    },
    showModal(index) {
    ...
    handleEdit(index, id) {
      this.$router.push("/order/informationCollect/" + id);
    },
    handleEdits(index, id) {
      this.$router.push("/order/informationCollect/Detail/" + id);
    },
    handleDelete(index) {
