  ...
  <div class="newTest">
    ...
    >
      ...
      <div class="btn">
        ...
        <!-- <el-button class="save" @click="dialogVisibleSave = true">暂存</el-button> -->
      </div>
    </el-form>
    ...
    <el-dialog class="dialogVisible" :visible.sync="dialogVisible" width="50%" true>
      <div>
        ...
        <!-- <span style="font-size: 16px;color: red;">信息采集模板必填!没有选择,数据会出现错误,没有选择的可以返回继续选择！！！</span> -->
      </div>
    ...
    <el-dialog class="dialogVisible" :visible.sync="dialogVisibleSave" width="50%" true>
      <div>
        <span>点击确定将暂存该考试</span>
      </div>
      <span slot="footer" class="dialog-footer">
