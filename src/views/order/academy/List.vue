      ...
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <el-form :inline="true">
            ...
            <el-form-item label>
              <el-input size="small" v-model="searchData.name" placeholder="学院名称"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="name" label="学院名称" width="200" align="center"></el-table-column>
            <el-table-column prop="name" label="学院代码" width="200" align="center"></el-table-column>
            <el-table-column prop="name" label="学院名称" width="auto" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    hanldeAdd() {
      // 添加
      this.$router.push("/order/academy/add");
    },
    showModal(index) {
    ...
    handleEdit(index, id) {
      this.$router.push("/order/academy/" + id);
    },
    handleEdits(index, id) {
      this.$router.push("/order/academy/Detail/" + id);
    },
    handleDelete(index) {
