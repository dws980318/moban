      ...
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <el-form :inline="true">
            ...
            <el-form-item label>
              <el-input size="small" v-model="searchData.name" placeholder="专业名称"></el-input>
            </el-form-item>
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择科目">
                <el-option
            ...
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择是否需要复试">
                <el-option
                  v-for="(item, key, index) in options"
                  :key="index"
                  :label="item.name"
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="name" label="专业名称" width="200" align="center"></el-table-column>
            <el-table-column prop="name" label="专业代码" width="200" align="center"></el-table-column>
            <el-table-column prop="name" label="专业名称" width="auto" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    hanldeAdd() {
      // 添加
      this.$router.push("/order/professional/add");
    },
    showModal(index) {
    ...
    handleEdit(index, id) {
      this.$router.push("/order/professional/" + id);
    },
    handleEdits(index, id) {
      this.$router.push("/order/professional/Detail/" + id);
    },
    handleDelete(index) {
