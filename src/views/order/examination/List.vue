      ...
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <el-form :inline="true">
            ...
            <el-form-item label>
              <el-input size="small" v-model="searchData.name" placeholder="考试名称"></el-input>
            </el-form-item>
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择招生专业">
                <el-option
            ...
            <el-form-item>
              <el-select size="small" v-model="searchData.typeid" clearable placeholder="请选择考试发布状态">
                <el-option
                  v-for="(item, key, index) in options"
                  :key="index"
                  :label="item.name"
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="name" label="考试名称" width="200" align="center"></el-table-column>
            <el-table-column prop="name" label="招生专业" width="200" align="center"></el-table-column>
            <el-table-column prop="name" label="开放报名时间" width="auto" align="center"></el-table-column>
            <el-table-column prop="name" label="截止报名时间" width="auto" align="center"></el-table-column>
            <el-table-column prop="name" label="信息采集模板" width="160" align="center"></el-table-column>
            <el-table-column prop="name" label="考试发布" width="160" align="center"></el-table-column>
            <el-table-column prop="name" label="成绩查询" width="160" align="center"></el-table-column>
            <el-table-column prop="menuName" label="联系方式" width="auto" header-align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    hanldeAdd() {
      // 添加
      this.$router.push("/order/examination/add");
    },
    showModal(index) {
    ...
    handleEdit(index, id) {
      this.$router.push("/order/examination/" + id);
    },
    handleEdits(index, id) {
      this.$router.push("/order/examination/Detail/" + id);
    },
    handleDelete(index) {
